...
$lang = array_merge($lang, array(
	...
	'CHI_BACKGROUND'								=> 'Background image/video',
	...
	'ACP_CHI_UPLOAD_SECTION' 						=> 'Upload section',
	...
	'ACP_CHI_IMAGE_FILE_UPLOADED' 					=> 'Uploaded %s complete',
	'ACP_CHI_IMAGE_FILE_FAIL' 						=> 'Failed to upload %s',
	'ACP_CHI_IMAGE_FILE_SIZE' 						=> 'Size of %s to big',
	'ACP_CHI_IMAGE_EXT_NOT_ALLOWED' 				=> 'Extension of %s is not allowed',
	'ACP_CHI_LOGOS_UPLOAD' 							=> 'Upload image logo',
	'ACP_CHI_BG_UPLOAD' 							=> 'Upload background',
	'ACP_CHI_DISABLE_SITE_INFO' 					=> 'Disable site information',
	'ACP_CHI_DISABLE_SITE_INFO_EXPLAIN' 			=> 'Disable SITENAME and SITE_DESCRIPTION in header where logo or background is set.',
	'ACP_CHI_ALLOWED_EXTENSION' 					=> 'Allowed extensions: %s',
	'ACP_CHI_ALLOWED_EXTENSION_IMAGES' 				=> 'Allowed image extension',
	'ACP_CHI_ALLOWED_EXTENSION_IMAGES_EXPLAIN' 		=> 'Set allowed image extension.',
	'ACP_CHI_ALLOWED_EXTENSION_VIDEO' 				=> 'Allowed video extension',
	'ACP_CHI_ALLOWED_EXTENSION_IMAGES_EXPLAIN' 		=> 'Set allowed video extension.',
	'ACP_CHI_LOGOS_UPLOAD_EXPLAIN' 					=> 'Path under your phpBB root directory, <samp>images/chl_logos</samp>.',
	'ACP_CHI_BG_UPLOAD_EXPLAIN' 					=> 'Path under your phpBB root directory, <samp>images/chl_backgrounds</samp>.',
